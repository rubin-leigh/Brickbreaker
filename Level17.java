...
public class Level17 implements Level
{
    ...
    public void placeBricks()
    {
        ...
        setLoc(5, mid - w, top + h);
        setLoc(6, mid - 3*w, top + 2*h);
        setLoc(7, mid - 2*w, top + 2*h);
        setLoc(8, mid - w, top + 2*h);
        setLoc(9, mid - 3*w, top + 3*h);
        setLoc(10, mid - 2*w, top + 3*h);
        setLoc(11, mid - w, top + 3*h);
        setLoc(12, mid, top + 3*h);
        setLoc(13, mid + w, top + 3*h);
        setLoc(14, mid + 2*w, top + 3*h);
        setLoc(15, mid - 2*w, top + 6*h);
        setLoc(16, mid - w, top + 6*h);
        setLoc(17, mid, top + 6*h);
        setLoc(18, mid + w, top + 6*h);
        setLoc(19, mid + 2*w, top + 6*h);
        setLoc(20, mid + 3*w, top + 6*h);
        setLoc(21, mid - 3*w, top + 9*h);
        setLoc(22, mid - 2*w, top + 9*h);
        setLoc(23, mid - w, top + 9*h);
        setLoc(24, mid, top + 9*h);
        setLoc(25, mid + w, top + 9*h);
