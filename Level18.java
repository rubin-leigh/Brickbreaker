...
public class Level18 implements Level
{
    ...
    public void placeBricks()
    {
        ...
        setLoc(14, mid, top + 2*h);
        setLoc(15, mid + w, top + 2*h);
        setLoc(16, mid + 2*w, top + 2*h);
        setLoc(17, mid - w, top + 3*h);
        setLoc(18, mid, top + 3*h);
        setLoc(19, mid + w, top + 3*h);
        setLoc(20, mid, top + 4*h);
        setLoc(21, mid - 3*w, top + 6*h);
        setLoc(22, mid - 2*w, top + 6*h);
        setLoc(23, mid + 2*w, top + 6*h);
        setLoc(24, mid + 3*w, top + 6*h);
        setLoc(25, mid - 2*w, top + 9*h);
        setLoc(26, mid - w, top + 9*h);
        setLoc(27, mid, top + 9*h);
        setLoc(28, mid + w, top + 9*h);
