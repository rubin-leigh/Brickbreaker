...
public class Level29 implements Level
{
    ...
    public void placeBricks()
    {
        ...
        setLoc(3, mid, top + h);
        setLoc(4, mid + w, top + h);
        setLoc(5, mid + 2*w, top + h);
        setLoc(6, mid + 3*w, top + h);
        setLoc(7, mid - w, top + 2*h);
        setLoc(8, mid - 3*w, top + 3*h);
        setLoc(9, mid - 2*w, top + 3*h);
        setLoc(10, mid - w, top + 3*h);
        setLoc(11, mid, top + 3*h);
        setLoc(12, mid + w, top + 3*h);
        setLoc(13, mid + 2*w, top + 3*h);
        setLoc(14, mid - w, top + 4*h);
        setLoc(15, mid - 2*w, top + 5*h);
        setLoc(16, mid - w, top + 5*h);
        setLoc(17, mid, top + 5*h);
        setLoc(18, mid + w, top + 5*h);
        setLoc(19, mid + 2*w, top + 5*h);
        setLoc(20, mid - w, top + 6*h);
        setLoc(21, mid - 3*w, top + 7*h);
        setLoc(22, mid - 2*w, top + 7*h);
        setLoc(23, mid - w, top + 7*h);
        setLoc(24, mid, top + 7*h);
        setLoc(25, mid + w, top + 7*h);
        setLoc(26, mid + 2*w, top + 7*h);
        setLoc(27, mid - w, top + 8*h);
        setLoc(28, mid - 2*w, top + 9*h);
        setLoc(29, mid - w, top + 9*h);
        setLoc(30, mid, top + 9*h);
        setLoc(31, mid + w, top + 9*h);
        setLoc(32, mid + 2*w, top + 9*h);
        setLoc(33, mid + 3*w, top + 9*h);
    }
