...
public class Level24 implements Level
{
    ...
    public void placeBricks()
    {
        ...
        setLoc(8, mid + 3*w, top + h);
        setLoc(9, mid - 3*w, top + 2*h);
        setLoc(10, mid, top + 2*h);
        setLoc(11, mid + 3*w, top + 2*h);
        setLoc(12, mid - 3*w, top + 3*h);
        setLoc(13, mid, top + 3*h);
        setLoc(14, mid + 3*w, top + 3*h);
        setLoc(15, mid - 3*w, top + 4*h);
        setLoc(16, mid, top + 4*h);
        setLoc(17, mid + 3*w, top + 4*h);
        setLoc(18, mid - 3*w, top + 5*h);
        setLoc(19, mid, top + 5*h);
        setLoc(20, mid + 3*w, top + 5*h);
