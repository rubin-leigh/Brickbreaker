...
public class Level13 implements Level
{
    ...
    public void placeBricks()
    {
        ...
        setLoc(1, mid - 2*w, top + 30 + h);
        setLoc(2, mid + w, top + 30 + h);
        setLoc(3, mid - 2*w, top + 30 + 2*h);
        setLoc(4, mid, top + 30 + 2*h);
        setLoc(5, mid + w, top + 30 + 2*h);
        setLoc(6, mid + 2*w, top + 30 + 2*h);
        setLoc(7, mid - 2*w, top + 30 + 3*h);
        setLoc(8, mid - w, top + 30 + 3*h);
        setLoc(9, mid, top + 30 + 3*h);
        setLoc(10, mid + w, top + 30 + 3*h);
        setLoc(11, mid + 2*w, top + 30 + 3*h);
        setLoc(12, mid + 3*w, top + 30 + 3*h);
        setLoc(13, mid - 2*w, top + 30 + 4*h);
        setLoc(14, mid, top + 30 + 4*h);
        setLoc(15, mid + w, top + 30 + 4*h);
        setLoc(16, mid + 2*w, top + 30 + 4*h);
        setLoc(17, mid - 2*w, top + 30 + 5*h);
        setLoc(18, mid + w, top + 30 + 5*h);
        setLoc(19, mid - 2*w, top + 30 + 6*h);
        setLoc(20, mid - 2*w, top + 30 + 7*h);
        setLoc(21, mid - w, top + 30 + 7*h);
        setLoc(22, mid, top + 30 + 7*h);
        setLoc(23, mid + w, top + 30 + 7*h);
        setLoc(24, mid + 2*w, top + 30 + 7*h);
        setLoc(25, mid + 3*w, top + 30 + 7*h);
    }
