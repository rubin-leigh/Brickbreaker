...
public class Level3 implements Level
{
    ...
    public void placeBricks()
    {
        ...
        setLoc(12, mid - 2*w, top + 30 + 4*h);
        setLoc(13, mid - w, top + 30 + 4*h);
        setLoc(14, mid + w, top + 30 + 4*h);
        setLoc(15, mid + 2*w, top + 30 + 4*h);
        //
        setLoc(16, mid - 2*w, top + 30 + 6*h);
        setLoc(17, mid - w, top + 30 + 6*h);
        setLoc(18, mid + w, top + 30 + 6*h);
        setLoc(19, mid + 2*w, top + 30 + 6*h);
        setLoc(20, mid - 2*w, top + 30 + 7*h);
        setLoc(21, mid - w, top + 30 + 7*h);
        setLoc(22, mid + w, top + 30 + 7*h);
        setLoc(23, mid + 2*w, top + 30 + 7*h);
    }
